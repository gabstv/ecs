...
func newviewPosRotSystem(w ecs.World) *viewPosRotSystem {
...
// PosRotSystem implements ecs.System
...
func GetPosRotSystem(w ecs.World) *PosRotSystem {
...
func (s *PosRotSystem) Setup(w ecs.World) {
	if s.initialized {
